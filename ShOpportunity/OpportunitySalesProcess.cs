...
namespace ShPlugins
{
	...
	public partial class OpportunitySalesProcess : Microsoft.Xrm.Sdk.Entity
	{
		
		/// <summary>
		/// Available fields, a the time of codegen, for the opportunitysalesprocess entity
		/// </summary>
		...
		public OpportunitySalesProcess(System.Guid id) : 
		...
		[System.Diagnostics.DebuggerNonUserCode()]
		public OpportunitySalesProcess(Microsoft.Xrm.Sdk.KeyAttributeCollection keyAttributes) : 
		...
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("salesorderidname")]
		public string SalesOrderIdName
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				if (this.FormattedValues.Contains("salesorderid"))
				{
					return this.FormattedValues["salesorderid"];
				}
				else
				{
					return default(string);
		...
		public ShPlugins.Opportunity Lk_OpportunitySalesProcess_OpportunityId
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<ShPlugins.Opportunity>("lk_opportunitysalesprocess_opportunityid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetRelatedEntity<ShPlugins.Opportunity>("lk_opportunitysalesprocess_opportunityid", null, value);
			}
		}
